...
class agent(object):
    ...
    def train_agent(self, PSR):
        ...
        if self.count % 2 == 0:
            ...
            self.Net.origin_Net.save_weights(filepath='origin_net_stand_tiger.h5', overwrite=True)
            self.Net.target_Net.save_weights(filepath='target_net_stand_tiger.h5', overwrite=True)
...
if __name__ == "__main__":
    ...
    EnvObject = POMDPEnvironment(filename='stand-tiger.95.the-newest-version.POMDP')
    ...
    #Agent.Net.origin_Net.load_weights(filepath='origin_net_stand_tiger.h5')
    #Agent.Net.target_Net.load_weights(filepath='target_net_stand_tiger.h5')
    PSR.gain_m()
    PSR.gain_M_ao()
