...
class agent(object):
    ...
    def train_agent(self, PSR):
        ...
        if self.count % 2 == 0:
            ...
            self.Net.origin_Net.save_weights(filepath='origin_net_tiger_domain.h5', overwrite=True)
            self.Net.target_Net.save_weights(filepath='target_net_tiger_domain.h5', overwrite=True)
